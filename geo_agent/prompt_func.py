...
def cache_files(client, pdf_uri, explain=False, time='20000s'):
...
async def generate_risk_actions(client, row_id, municipality_context, heat_risk, flood_risk, fire_risk, lst_day, lst_night,
